<?php
namespace RindowTest\Security\Core\Authorization\ConsensusBasedDecisionManagerTest;
...
use Rindow\Security\Core\Authorization\Vote\ConsensusBased;
...
class Test extends TestCase
{
	public function testAllowed()
	{
		...
		$decisionManager = new ConsensusBased($voters);
